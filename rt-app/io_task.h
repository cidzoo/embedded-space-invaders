...
/*! \brief Fonction à appelé au début pour lancer la tâche de gestion des entrées/sorties
 ...
 *  la tâche de gestion des entrées/sorties (en principe avant la fonction io_task_cleanup_objects()).
 */
